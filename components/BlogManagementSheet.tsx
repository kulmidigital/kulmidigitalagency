...
export default function BlogManagementSheet() {
  ...
  return (
    <Sheet>
      ...
      <SheetContent
        className={`${clashDisplay.className} min-w-[40vw] sm:w-[90vw] overflow-y-auto dark:bg-gray-900`}>
        <SheetHeader>
        ...
        <div className='mt-6'>
          <Input
            ...
            className='w-full rounded-xl border-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-[#F56E0F] focus:ring-[#F56E0F]'
          />
        </div>
          ...
          {isLoading ? (
            ...
            <>
              {filteredPosts.map((post) => (
                <div
                  key={post.id}
                  className='flex items-start space-x-4 p-4 rounded-lg border border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200'>
                  {post.image && (
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    {post.categoryName && (
                      <span className='inline-block mt-1 text-xs bg-gray-100 dark:bg-gray-700 dark:text-gray-300 px-2 py-1 rounded-full'>
                        {post.categoryName}
                      </span>
                    )}
                  </div>
                  <div className='flex items-center space-x-2'>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <button className='p-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors duration-200'>
                          <svg
                            xmlns='http://www.w3.org/2000/svg'
                            className='h-5 w-5'
                            fill='none'
                      ...
                      <AlertDialogContent
                        className={`${clashDisplay.className} dark:bg-gray-800`}>
                        <AlertDialogHeader>
