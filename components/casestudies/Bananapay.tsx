      ...
      <div className='flex flex-col md:flex-row md:justify-between md:gap-10'>
        <div className='w-full md:w-[70%]'>
          <SlideReveal direction='up' duration={0.7}>
            ...
            <p
              className={`${plusJakartaSans.className} text-sm md:text-[14px] mt-4 md:mt-6 font-light`}>
        ...
        <div className='w-full md:w-[30%] mt-6 md:mt-0'>
          <SlideReveal direction='right' duration={0.7}>
            <h3
              className={`${clashDisplay2.className} text-lg md:text-[22px] font-light `}>
              <span className={`${clashDisplay.className} font-bold`}>
                Date:{" "}
              </span>{" "}
      ...
      <div className='flex flex-col md:flex-row md:justify-between md:gap-10 mt-12 md:mt-20'>
        <div className='w-full md:w-1/2'>
          <SlideReveal direction='left' duration={0.7}>
            <h1 className='text-3xl md:text-4xl lg:text-5xl font-light'>
              More About The <span className='text-[#F56E0F]'>Project:</span>
            </h1>
            <p className='text-lg md:text-xl lg:text-[20px] mt-4 md:mt-6 font-light'>
        ...
        <div className='w-full md:w-1/2 mt-6 md:mt-16'>
          <SlideReveal direction='up' duration={0.7}>
            <h2
              className={`${plusJakartaSans.className} text-base md:text-lg lg:text-[18px] font-light`}>
