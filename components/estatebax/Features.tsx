...
const Features = () => {
  return (
    <div
      className={`${clashDisplay.className} py-4 md:py-8 px-0 md:px-8 dark:bg-gray-900`}
      id='features'>
      <div className='w-[96%] md:container mx-auto'>
        {/* Real Estate Info Section */}
        <SlideReveal direction='up' duration={0.7}>
          <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-800 dark:text-gray-100 mb-6 sm:mb-8'>
            REAL ESTATE INFO AND MARKETING
          </h2>

          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12 sm:mb-20'>
            {/* Large Feature Card */}
            <div className='lg:col-span-2 row-span-2 rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-8 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-base sm:text-lg`}>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
        ...
        <SlideReveal direction='up' duration={0.7}>
          ...
          <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-8 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group mb-12 sm:mb-20'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-12 sm:mb-20'>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Keep all your contacts organized and just a click away. Easily
                  contact them through WhatsApp, Viber, or Telegram. Automate a
                  comprehensive timeline for your contact, including all
                  interactions, tasks, and related opportunities.
                </p>
              </div>
            </div>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Effortlessly match your properties with potential customers
                  and conveniently track all related events in an automated
                  timeline. Each task completion related to it will trigger the
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Easily send emails to one or more contacts. Customize your
                  emails with property-related content, including photos, basic
                  data, and a link to a comprehensive property preview.
                </p>
              </div>
            </div>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Every landing page includes a contact form with agent data.
                  Sharing your landing page on social media will now generate
                  leads in the contacts hub each time someone submits a contact
                  form.
                </p>
              </div>
            </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-12 sm:mb-20'>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Our task tracking and collaboration tool that uses boards,
                  lists, and cards that empowers agency agents to efficiently
                  manage their tasks and projects, enhancing overall
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Easily manage team members, system roles, and their
                  permissions. Tailor your system to suit your team members'
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-12 sm:mb-20'>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Gain a comprehensive understanding of landing page analytics
                  and easily track the performance of your shared links on
                  social media and other channels in EstateBax Analytics.
                </p>
              </div>
            </div>
            ...
            <div className='rounded-2xl sm:rounded-3xl bg-white/50 dark:bg-gray-800/50 p-4 sm:p-6 shadow-lg border border-white/60 dark:border-gray-700 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 cursor-pointer relative overflow-hidden group'>
              ...
              <div className='relative z-10'>
                ...
                <p
                  className={`${plusJakartaSans.className} text-gray-700 dark:text-gray-300 text-sm sm:text-base`}>
                  Our software includes a robust report generator that allows
                  users to create detailed reports on tasks, agents, contacts,
                  and properties, providing valuable insights and analytics for
                  informed decision-making and tracking performance effectively.
                </p>
              </div>
            </div>
          </div>
