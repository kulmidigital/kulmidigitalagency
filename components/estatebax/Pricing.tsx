...
const Pricing = () => {
  ...
  return (
    <div
      className={`${clashDisplay.className} py-4 md:py-8 px-0 md:px-8 bg-gray-50`}>
      <div className='w-[96%] md:container mx-auto'>
        <SlideReveal direction='up' duration={0.7}>
          <div className='text-center mb-8 sm:mb-12'>
            ...
            <p
              className={`${plusJakartaSans.className} text-gray-600 text-sm sm:text-base mb-6 sm:mb-8`}>
            ...
            {currentPlans.map((plan, index) => (
              <div
                ...
                <div className='flex-grow'>
                  ...
                  <p
                    className={`${plusJakartaSans.className} text-gray-600 text-sm sm:text-base mb-4 sm:mb-6`}>
                    {plan.description}
                  </p>
                  ...
                  <ul className='space-y-3 sm:space-y-4 mb-6 sm:mb-8'>
                    {plan.features.map((feature, i) => (
                      <li key={i} className='flex items-start gap-2'>
                        ...
                        <span
                          className={`${plusJakartaSans.className} text-gray-600 text-sm sm:text-base`}>
                          {feature}
                        </span>
                      </li>
                    ))}
