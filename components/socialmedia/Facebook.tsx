    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto'>
      ...
      <div className='col-span-1 sm:col-span-2 row-span-2 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 sm:p-8 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <h2 className='text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4 font-clash-display'>
            Partner with Facebook Specialists
          </h2>
          <p className='text-gray-700 dark:text-gray-300 text-lg'>
            Our Facebook experts are now your Facebook experts. As a full
            extension of your team, we'll work together to crush your Ecommerce
            business goals.
          </p>
        </div>
      </div>
      ...
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <h3 className='text-xl font-bold text-gray-800 dark:text-gray-100 mb-2 font-clash-display'>
            Leave the Competition Behind
          </h3>
          <p className='text-gray-700 dark:text-gray-300 text-sm'>
            While competitors are still scratching their heads about Facebook ad
            campaigns, you'll be busy knocking your objectives out of the park.
          </p>
        </div>
      </div>
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 dark:text-gray-300 text-sm'>
            We'll provide your brand with a stream of fresh content, designed
            specifically to engage and convert Facebook audiences.
          </p>
        </div>
      </div>
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 dark:text-gray-300 text-sm'>
            We'll take care of the heavy lifting, managing every aspect of your
            Facebook advertising. All you need to do is enjoy the results.
          </p>
        </div>
      </div>
  ...
  const whySection = (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8'>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <h3 className='text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4 font-clash-display'>
          Massive User Base
        </h3>
        <p className='text-gray-700 dark:text-gray-300'>
          With billions of active users, Facebook offers unparalleled reach for
          your brand. Connect with potential customers across demographics and
          regions.
        </p>
      </div>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700 dark:text-gray-300'>
          Facebook's sophisticated targeting options allow you to reach your
      ...
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700 dark:text-gray-300'>
          From image and video ads to carousel and instant experiences, Facebook
          offers a wide range of ad formats to showcase your products or
