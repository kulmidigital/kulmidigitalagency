    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto'>
      ...
      <div className='col-span-1 sm:col-span-2 row-span-2 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 sm:p-8 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 dark:text-gray-300 text-base sm:text-lg'>
            Our Twitter specialists will help you create engaging content, grow
            your following, and leverage real-time conversations to boost your
            brand's presence.
          </p>
        </div>
      </div>
      ...
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 dark:text-gray-300 text-sm'>
            Craft compelling tweets that resonate with your audience and
      ...
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 dark:text-gray-300 text-sm'>
            Stay on top of trending topics and hashtags to increase your
      ...
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg border border-white/60 dark:border-gray-700/60 transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-700/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 dark:text-gray-300 text-sm'>
            Implement strategies to grow your Twitter following and expand your
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8'>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700 dark:text-gray-300'>
          X's fast-paced nature allows for real-time engagement with your
          audience, perfect for timely updates and customer service.
        </p>
      </div>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700 dark:text-gray-300'>
          X's public nature and retweet feature can help your content go viral
          and increase your brand's visibility exponentially.
        </p>
      </div>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700 dark:text-gray-300'>
          X's advertising platform offers precise targeting options, allowing
          you to reach your ideal audience based on interests, behaviors, and
          more.
        </p>
      </div>
    </div>
