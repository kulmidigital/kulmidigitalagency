      ...
      <div className='col-span-1 sm:col-span-2 row-span-2 rounded-3xl bg-white/50 p-6 sm:p-8 shadow-lg border border-white/60 transition-all duration-300 hover:bg-white/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 text-base sm:text-lg'>
            Our TikTok specialists will help you create viral-worthy content, engage with trends, and reach a massive, young audience through this rapidly growing platform.
          </p>
        </div>
      </div>
      ...
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 p-6 shadow-lg border border-white/60 transition-all duration-300 hover:bg-white/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 text-sm'>
            Stay ahead of the curve by tapping into viral trends and challenges to boost your brand's visibility.
          </p>
        </div>
      </div>
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 p-6 shadow-lg border border-white/60 transition-all duration-300 hover:bg-white/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 text-sm'>
            Connect with the coveted younger demographic where they spend most of their digital time.
          </p>
        </div>
      </div>
      <div className='col-span-1 sm:col-span-2 lg:col-span-1 rounded-3xl bg-white/50 p-6 shadow-lg border border-white/60 transition-all duration-300 hover:bg-white/70 hover:scale-[1.02] cursor-pointer relative overflow-hidden group'>
        ...
        <div className='relative z-10'>
          ...
          <p className='text-gray-700 text-sm'>
            Create short, captivating videos that resonate with TikTok's unique audience and format.
          </p>
        </div>
      </div>
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8'>
      <div className='bg-white rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700'>
          TikTok's rapid rise offers a unique opportunity to reach a vast, engaged audience and establish your brand early on this booming platform.
        </p>
      </div>
      <div className='bg-white rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700'>
          TikTok's algorithm and user behavior lead to some of the highest engagement rates across all social platforms, giving your content more chances to go viral.
        </p>
      </div>
      <div className='bg-white rounded-lg shadow-lg p-6 sm:p-8 transition-all duration-300 hover:shadow-xl'>
        ...
        <p className='text-gray-700'>
          From in-feed ads to branded effects and hashtag challenges, TikTok offers innovative advertising options that feel native to the platform and resonate with users.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <SocialMediaLayout
      heroProps={{
        ...
        description: "Harness the power of short-form video to reach and engage a massive, young audience.",
      }}
